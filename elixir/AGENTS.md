...
This directory contains the Elixir agent orchestration service that polls Linear, creates per-issue workspaces, and runs GitHub Copilot CLI through the Symphony bridge.
...
- Workspace safety is critical:
  - Never run GitHub Copilot CLI turn cwd in source repo.
